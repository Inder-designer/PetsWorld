...
import CartSkeleton from "../components/LoadingShimmers/CartSkeleton";
...
const CartPage = () => {
  ...
  const handleOrder = () => {
    ...
    const orderDetails = {
      ...
      subTotal: subTotal,
      total: total + (total < 499 && 40),
      expiresAt: expires,
      deliveryCharges: total < 499 ? 40 : 0
    };
            ...
            {cartItems.length > 0 ? (
              <div className="flex gap-5">
                <div className="leftSide w-[65%]">
                  <div className="bg-white shadow-[rgba(0,0,0,0.2)_0px_1px_2px_0px]">
                    {cartProduct.length > 0 &&
                      cartProduct.map((cartItem) => (
                        <div
                          className="flex p-6 border gap-5"
                          key={cartItem._id}
                        >
                          <Link
                          ...
                          <div>
                            <h6 className="font-semibold">
                              <Link
                                to={`/${
                                  cartItem.product.id
                                }+${encodeURIComponent(cartItem.product.name)}`}
                              >
                                {cartItem.product.name}
                              </Link>
                            </h6>
                ...
                <div className="rightSide w-[35%] sticky top-0">
                    ...
                    <div className="px-6">
                      ...
                      <div className="border-[#e0e0e0] border-t py-4 border-dashed">
                        <div className="flex justify-between  items-start text-xl font-semibold ">
                          ...
                          <span>{CurrencyFormat(total + (total < 499 && 40))}</span>
                        </div>
                      </div>
                      ...
                      {subTotal - total > 0 && (
                        <div className="border-[#e0e0e0] border-t  border-dashed py-3 text-[#388e3c] font-medium">
                          <p>
                            You will save {CurrencyFormat(subTotal - total, 0)}{" "}
                            on this order
                          </p>
                        </div>
                      )}
