...
const SignUp = () => {
  ...
  const handleRegister = (values) => {
    ...
    dispatch(userRegister({ name, email, password, navigate }));
                    ...
                    <div>
                      <div className="relative">
                        ...
                        <Field
                          ...
                          className="pl-10 block w-full rounded-md py-1.5 text-gray-900 shadow-sm border border-gray-300 focus:border-gray-300 peer placeholder:text-gray-400 sm:text-sm sm:leading-6"
                        />
                        {showPassword ? (
                          <VisibilityOffOutlined
