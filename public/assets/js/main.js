(function ($) {
	...
	$('[data-countdown]').each(function () {
		...
		$this.countdown(finalDate, function (event) {
			$this.html(event.strftime('<span className="cdown days"><span className="time-count">%-D</span> <p>Days</p></span> <span className="cdown hour"><span className="time-count">%-H</span> <p>Hour</p></span> <span className="cdown minutes"><span className="time-count">%M</span> <p>Minute</p></span> <span className="cdown second"> <span><span className="time-count">%S</span> <p>Second</p></span>'));
		});
	});
